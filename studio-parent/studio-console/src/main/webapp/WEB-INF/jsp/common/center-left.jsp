...
<nav style="border:1px solid #DEDEDE;width: 205px;height: 100%;position: absolute;">
	<!-- 标题 -->
	<nav class="navbar navbar-default" style="margin-bottom: 5px;min-height: 28px;width: 203px;">
